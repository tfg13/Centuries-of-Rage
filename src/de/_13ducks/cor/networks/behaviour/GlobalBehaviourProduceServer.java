 ...
 * @author 2nd
 */
public class GlobalBehaviourProduceServer extends GlobalBehaviour {
    double prodrate = 0.0;
    long lastupdate = -1;

    public GlobalBehaviourProduceServer (ServerCore.InnerServer newinner, NetPlayer player, int callsPerSecond) {
        super(player, callsPerSecond, true);
    }
    ...
    public void incrementProdrate(double increase) {
