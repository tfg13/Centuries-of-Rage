...
public class ServerNetController implements Runnable {
    ...
    public class ServerHandler implements Runnable {
        ...
        public GameObject temps055_1;
        public ArrayList<Unit> temps055_2;
        public boolean temps055_atkmode;
        public int moveMode;
        ...
        private void initCmdArr() {
            ...
            cmdMap[1] = new de._13ducks.cor.networks.cmd.server.S001_LOAD_MAP_INIT();
            cmdMap[3] = new de._13ducks.cor.networks.cmd.server.S003_PREP_START();
            cmdMap[6] = new de._13ducks.cor.networks.cmd.server.S006_TOGGLE_PAUSE();
            cmdMap[7] = new de._13ducks.cor.networks.cmd.server.S007_LOAD_GAME();
            cmdMap[9] = new de._13ducks.cor.networks.cmd.server.S009_REQUEST_DATA();
            cmdMap[10] = new de._13ducks.cor.networks.cmd.server.S010_CLIENT_OFFLINE();
            cmdMap[14] = new de._13ducks.cor.networks.cmd.server.S014_LOBBY_COMS();
            cmdMap[16] = new de._13ducks.cor.networks.cmd.server.S016_CONSTRUCT_STOP();
            cmdMap[17] = new de._13ducks.cor.networks.cmd.server.S017_CONSTRUCT_START();
            ...
            cmdMap[42] = new de._13ducks.cor.networks.cmd.server.S042_EVACUATE_UNIT();
