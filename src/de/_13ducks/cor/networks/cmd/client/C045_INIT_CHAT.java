...
/**
 * Initiiert eine Nachtichten-Übertragung
 */
public class C045_INIT_CHAT extends ClientCommand {

    @Override
    public void process(byte[] data, ClientHandler handler, InnerClient rgi) {
        // "Init" für Chat - setzt nur die playerId
        handler.playerId45 = rgi.readInt(data, 1);
    }
}
