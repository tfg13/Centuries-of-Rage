...
/**
 * Startet das Spiel endgültig. Nach diesem Befehl läuft das Spiel.
 */
public class C004_START_GAME extends ClientCommand {

    @Override
    public void process(byte[] data, ClientHandler handler, InnerClient rgi) {
        rgi.rogGraphics.setLoadStatus(10);
        // Jetzt durchstarten
        rgi.game.startMainloop();
