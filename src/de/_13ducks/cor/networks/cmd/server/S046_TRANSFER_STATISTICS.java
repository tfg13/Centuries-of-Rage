...
/**
 * Statistiken übertragen
 */
public class S046_TRANSFER_STATISTICS extends ServerCommand {

    @Override
    public void process(byte[] data, ServerHandler handler, InnerServer rgi) {
        // Statistiken vom Client empfangen und an alle Clients senden
        rgi.netctrl.broadcastDATA(rgi.packetFactory((byte) 46, rgi.readInt(data, 1), rgi.readInt(data, 2), handler.client.playerId, 0));
    }
}
