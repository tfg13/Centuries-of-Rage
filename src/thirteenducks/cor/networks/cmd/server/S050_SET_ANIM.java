...
/**
 * Animationsdaten - weiterleiten
 */
public class S050_SET_ANIM extends ServerCommand {

    @Override
    public void process(byte[] data, ServerHandler handler, InnerServer rgi) {
        // Animationsdaten, das ist nix für den Server, nur weiterleiten
        rgi.netctrl.broadcastDATA(rgi.packetFactory((byte) 50, rgi.readInt(data, 1), rgi.readInt(data, 2), rgi.readInt(data, 3), rgi.readInt(data, 4)));
    }
}
