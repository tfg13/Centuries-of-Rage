...
/**
 * Der Client möchte seine eigene Einheit entfernen
 */
public class S028_KILL_UNIT extends ServerCommand {

    @Override
    public void process(byte[] data, ServerHandler handler, InnerServer rgi) {
        // Ein Client will seine eigene Einheit killen
        // Unit suchen
        Unit unit28 = rgi.netmap.getUnitviaID(rgi.readInt(data, 1));
        if (unit28 != null) {
            // Weg damit
