...
/**
 * Initiiert eine Rohdatenübertragung
 * Diese wird verwendet für Map und Game-Dateien
 */
public class C009_INIT_RAW_DATA extends ClientCommand {

    @Override
    public void process(byte[] data, ClientHandler handler, InnerClient rgi) {
        handler.temp09 = rgi.readInt(data, 1);
        handler.temp08 = new byte[rgi.readInt(data, 2)];
        handler.temp08index = 0;
    }
}
