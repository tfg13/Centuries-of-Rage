...
/**
 * Ein Ressource soll entfernt werden.
 */
public class C033_KILL_RES extends ClientCommand {

    @Override
    public void process(byte[] data, ClientHandler handler, InnerClient rgi) {
        // Ressource fertig, löschen
        // Suchen
        Ressource res33 = rgi.mapModule.getRessourceviaID(rgi.readInt(data, 1));
        if (res33 != null) {
            rgi.mapModule.killRessource(res33);
        } else {
            System.out.println("FixMe: RessourceID mismatch (cmd33)");
        }
    }
}
