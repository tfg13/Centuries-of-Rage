...
/**
 * Triggert eine Fehlermeldung.
 * Für Fehler, die wärend des Ladevorgangs auftreten
 */
public class C011_ERROR extends ClientCommand {

    @Override
    public void process(byte[] data, ClientHandler handler, InnerClient rgi) {
        // ERROR beim laden - mitteilen (nur triggern)
        rgi.rogGraphics.triggerLaunchError(rgi.readInt(data, 1));
    }
}
